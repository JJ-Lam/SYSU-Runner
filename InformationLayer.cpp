...
bool InformationLayer::init()
{
	...
	//暂停按钮
	auto pause = MenuItemImage::create("CloseNormal.png","CloseSelected.png",CC_CALLBACK_0(InformationLayer::pause,this));
	...
	//暂停恢复选项
	auto resume = MenuItemImage::create("CloseNormal.png","CloseSelected.png",CC_CALLBACK_0(InformationLayer::resume,this));
	resume->setPositionX(resume->getPositionX()-50);
	auto back = MenuItemImage::create("CloseNormal.png","CloseSelected.png",CC_CALLBACK_0(InformationLayer::backToMenu,this));
	...
	//关卡结束选项
	auto replay = MenuItemImage::create("CloseNormal.png","CloseSelected.png",CC_CALLBACK_0(InformationLayer::replay,this));
	replay->setPositionX(replay->getPositionX()-50);
	auto back2 = MenuItemImage::create("CloseNormal.png","CloseSelected.png",CC_CALLBACK_0(InformationLayer::backToMenu,this));
	back2->setPositionX(back2->getPositionX()+50);
